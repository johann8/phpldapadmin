...
$config->custom->appearance['timezone'] = '{{ TZ }}';
...
$config->custom->appearance['language'] = '{{ PHPLDAPADMIN_LANGUAGE }}';
...
$servers->setValue('server','name','{{ PHPLDAPADMIN_SERVER_NAME }}');
...
$servers->setValue('server','host','{{ PHPLDAPADMIN_SERVER_HOST }}');
...
$servers->setValue('login','bind_id','{{ PHPLDAPADMIN_BIND_ID }}');
...
$servers->setValue('appearance','pla_password_hash','{{ PHPLDAPADMIN_PASSWORD_HASH }}');
